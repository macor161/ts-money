...
describe('Money', function () {
    ...
    it('should create a new instance from decimal using `.fromDecimal()` even if too many decimal places if rounder function provided', () => {
        ...
        let money1 = Money.fromDecimal({amount: 10.01, currency: 'EUR'}, Rounding.ROUND_CEIL)
    ...
    it('positive check works correctly', () => {
        var subject = new Money(1000, 'EUR')
    ...
    it('negative check works correctly', () => {
        var subject = new Money(1000, 'EUR')
        var subject1 = new Money(-1000, 'EUR')
